...
$$
\mathbb{E}_{\mathbf{z}}\big[\mathrm{a}[\mathbf{z}]\big]=\int\mathrm{a}[\mathbf{z}]q(\mathbf{z}|\mathbf{x},\boldsymbol{\theta})d\mathbf{z}\approx\frac{1}{N}\sum_{n=1}^{N}\mathrm{a}[\mathbf{z}_{n}^{*}],
\tag{17.22}
$$
...
$$
\mathrm{ELBO}[\theta,\phi]\quad\approx\quad\log\big[Pr(\mathbf{x}|\mathbf{z}^{*},\phi)\big]-\mathrm{D}_{KL}\Big[q(\mathbf{z}|\mathbf{x},\boldsymbol{\theta})\Big|\Big|Pr(\mathbf{z})\Big].
$$
...
$$
\mathrm{ELBO}[\theta,\phi]\quad\approx\quad\log\big[Pr(\mathbf{x}|\mathbf{z}^{*},\phi)\big]-\beta\cdot\mathrm{D}_{KL}\Big[q(\mathbf{z}|\mathbf{x},\boldsymbol{\theta})\Big|\Big|Pr(\mathbf{z})\Big],
\tag{17.30}
$$
